...
that establishes:
    ...
    - Two different aliases for each of the sensors (DryGoods and Receiving-Exiting) in order to generate more 
      descriptive location names
    - An EXIT personality in order to detect when an item leaves the Receiving-Exiting location
