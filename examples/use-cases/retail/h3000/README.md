...
YOUR_PROJECT_DIRECTORY/rsp-sw-toolkit-gw/examples/use-cases/retail/h3000/), by replacing the sensor device ids in the 
...
using the [cluster config](http://localhost:8080/web-admin/cluster-config.html) page.
    ...
    YOUR_PROJECT_DIRECTORY/rsp-sw-toolkit-gw/examples/use-cases/retail/h3000/DevkitQsrCluster.json.
