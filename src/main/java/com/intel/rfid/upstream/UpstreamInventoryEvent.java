...
import com.intel.rfid.api.InventoryEvent;
import com.intel.rfid.api.RSPInventoryEvent;
import com.intel.rfid.inventory.Tag;
import com.intel.rfid.inventory.TagEvent;

public class UpstreamInventoryEvent extends InventoryEvent {
    ...
    public void add(RSPInventoryEvent.Item _item, String _facilityId, String _deviceId) {
        Item item = new Item();
        item.facility_id = _facilityId;
