...
import com.intel.rfid.api.data.TagDirection;

import java.util.ArrayList;
import java.util.List;

public class SensorInventoryEventNotification extends JsonNotification {

    public static final String METHOD_NAME = "inventory_event";

    public SensorInventoryEventNotification() {
        method = METHOD_NAME;
    }
